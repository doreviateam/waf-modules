...
class SaleOrderDispatch(models.Model):
    _inherit = 'sale.order'
    ...
    def _create_delivery_after_split(self):
        ...
        return super(SaleOrderDispatch, self).action_confirm()
    ...
    def action_confirm(self):
        ...
        if self.delivery_mode == DELIVERY_MODE_DISPATCH:
            ...
            result = super(SaleOrderDispatch, self).action_confirm()
    ...
    def _action_launch_stock_rule(self):
        ...
        super(SaleOrderDispatch, self)._action_launch_stock_rule()
    ...
    def _create_delivery(self):
        ...
        return super(SaleOrderDispatch, self)._create_delivery() 